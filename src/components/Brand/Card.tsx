  ...
  return (
    <div className="text-green-500 flex justify-center items-center gap-2 px-2 py-20 mt-5 mb-5 ">
      ...
      <div className="flex flex-col items-center justify-start md:items-start">
        <h1 className="font-bold text-2xl md:text-4xl flex justify-start gap-2"><span>+</span> <NumberAnimate n={number} /></h1>
        <span className="text-white text-xs font-bold uppercase">{description}</span>
      </div>
    </div>
  )
}