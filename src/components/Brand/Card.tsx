...
export const Card = ({number, description, icon}: CardProps) => {
  return (
    <div className="text-white flex justify-center  items-center gap-2 px-2 py-10 mt-2 sm:mt-5 sm:mb-5 ">
      ...
      <div className="flex flex-col items-center justify-start md:items-start">
        ...
        <span className="text-gray-200 text-xs sm:text-sm md:text-lg font-bold uppercase">{description}</span>
      </div>
    </div>
  )
}